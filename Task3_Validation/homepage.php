...
<head>
    ...
    <style>
            ...
            margin-top: 30px;
            z-index: 101;
            background-color: rgb(2, 142, 142);
            font-weight: bold;
            color: rgb(11, 22, 33);
            white-space: nowrap; 
            align-items: center;
...
<body id="main-body">
    ...
    <div class="header" data-aos="fade-down">
        <div class="left-section"><!--Header-Logo Section-->
            <img class="mv-icon" src="icons/mv_white.png" data-aos="zoom-in" data-aos-delay="500">
        </div>

        <div class="right-section"> <!--Header-Right Section-->
    <a href="#home-section" class="header-link" data-aos="fade-right" data-aos-delay="600">Home</a>
    <a href="#about-us-section" class="header-link" data-aos="fade-right" data-aos-delay="600">About Us</a>
    <a href="#our-team-section" class="header-link" data-aos="fade-right" data-aos-delay="600">Our Team</a>
    <a href="#contact-us-section" class="header-link" data-aos="fade-right" data-aos-delay="600">Contact Us</a>
    <i class="fa-solid fa-user" id="user-sign-in-button" data-aos="zoom-in" data-aos-delay="700"></i>
    <div class="user-popup">
        <p>User: <?php echo $_SESSION['name']; ?></p>
    </div>
    <a class="logout-anchor" href="logout.php" data-aos="zoom-in" data-aos-delay="800">Logout</a>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    userIcon.addEventListener('mouseenter', function() {
        ...
        userPopup.style.top = `${rect.bottom + window.scrollY}px`;
        userPopup.style.left = `${rect.left + window.scrollX}px`;
        userPopup.style.display = 'flex'; // Changed to 'flex' to use flex properties
    });
